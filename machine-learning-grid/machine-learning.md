...
1. Make sure you're using Java 8 or later. ML Grid is not compatible with previous java versions.
...
3. Make sure you're using Java 8 or later. ML Grid is not compatible with previous versions of Java.
