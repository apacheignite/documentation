...
[block:callout]
{
  ...
  "body": "Using the Ignite JDBC driver, you can achieve fast data preloading in a so-called streaming mode. Learn more about this mode in the [streaming related section of the JDBC Driver documentation](doc:jdbc-driver#streaming-mode)."
}
[/block]
