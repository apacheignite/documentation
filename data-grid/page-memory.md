...
All the memory tiers listed above have been discontinued in Apache Ignite 2.0 in favor of a completely new off-heap based `page memory` with possible on-heap caching: 
[block:image]
{
  "images": [
    {
...
[/block]
The benefits of the page memory are the following:
