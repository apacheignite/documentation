...
[/block]
A memory chunk is a physical continuous byte array obtained from the underlying operating system. The chunk is divided into pages of fixed size. There are several types of pages that can reside in the chunk:
