...
Ignite does not avoid distributed deadlocks, but offers a built-in functionality that makes it easier to debug and fix such situations.
...
[/block]
As shown below, `TransactionDeadlockException` message contains useful information that can help you find the reason for the deadlock.
[block:code]
{
  "codes": [
    {
