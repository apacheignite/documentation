...
[block:callout]
{
  ...
  "body": "You can use `ignite-version` property for build Zeppelin with specific Ignite version. For example:\n`mvn clean install -Dignite.version=1.1.0-incubating -DskipTests`\n\nUse version `1.1.0-incubating` or later."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/3nNlueyiRZWW4tftjECy",
        "Selection_001.png",
        "1142",
        "618",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/IQnis6d5RgW6WbFyq5IQ",
        "Selection_002.png",
        "1142",
        "671",
        "#3571a4",
...
See also [JDBC Driver](http://apacheignite.readme.io/v1.1/docs/jdbc-driver)  section for details. 

### Configuring Ignite Interpreter
For most simple cases Ignite interpreter requires the following properties:

  * `ignite.addresses` - Coma separated list of Ignite cluster hosts. See [Cluster Configuration](http://apacheignite.readme.io/v1.1/docs/cluster-config) section for details.
  * `ignite.clientMode` - You can connect to the Ignite cluster as client or server node. See [Clients vs. Servers](http://apacheignite.readme.io/v1.1/docs/clients-vs-servers) section for details. Use `true` or `false` values in order to connect in client or server mode respectively.
  * `ignite.peerClassLoadingEnabled` - Enables peer-class-loading. See [Zero Deployment](http://apacheignite.readme.io/v1.1/docs/zero-deployment) section for details. Use `true` or `false` values in order to enable or disable P2P class loading respectively.
...
Before using Zeppelin we need start Ignite cluster. Download [Apache Ignite In-Memory Data Fabric binary release](http://mirrors.ibiblio.org/apache//incubator/ignite/1.1.0/apache-ignite-fabric-1.1.0-incubating-bin.zip) and unpack the downloaded archive:
`unzip apache-ignite-fabric-1.1.0-incubating-bin.zip -d <dest_dir>`

Examples are shipped as a separate Maven project, so to start running you simply need
to import provided `<dest_dir>/apache-ignite-fabric-1.1.0-incubating-bin/pom.xml` file into your favourite IDE.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/GGlzq0GRUuNf5O4wjJ88",
        "Selection_003.png",
        "1137",
        "662",
        "#366fa2",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/pCdSlg4WQzu4oOs6oJHd",
        "Selection_004.png",
        "1157",
        "232",
        "",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/nME5WYnUToi6NmVbkmTo",
        "Selection_005.png",
        "1158",
        "234",
        "#3474ac",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/bU5feKIdQTmomvb3L7fU",
        "Selection_006.png",
        "1156",
        "257",
        "#3474ac",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/3qaeS1L4RTSZ4bzdKdt2",
        "Selection_007.png",
        "1143",
        "640",
        "#336da1",
  ...
  "images": [
    {
      ...
      "image": [
        "https://www.filepicker.io/api/file/hqUMAO6FT2oM5EQeDYvO",
        "Selection_008.png",
        "1157",
        "551",
        "#549bc4",
  ...
  "images": [
    {
      ...
      "image": [
        "https://www.filepicker.io/api/file/jfR1EPbSQGPK6L9cjvcQ",
        "Selection_009.png",
        "1141",
        "650",
        "#3074ad",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/9crbD020TeafGZnAKgVD",
        "Selection_010.png",
        "1156",
        "473",
        "#3474ac",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://www.filepicker.io/api/file/JxlAEniRS29Io4kgqf6A",
        "Selection_011.png",
        "1143",
        "649",
        "#3474ac",
