...
[block:parameters]
{
  "data": {
    ...
    "11-1": "The path to Apache Ignite config file on local file system.",
    "11-2": "`N/A`",
    "11-3": "`/opt/ignite/ignite-config.xml`",
    "14-0": "`IGNITE_USERS_LIBS`",
    "14-1": "The path to libs which will be added to classpath.",
    "14-2": "`N/A`",
    "14-3": "`/opt/libs/`",
    "16-0": "`MESOS_MASTER_URL`",
    "16-1": "Mesos ZooKeeper URL to locate leading master.",
    "16-2": "`zk://localhost:2181/mesos`",
    "16-3": "`zk://176.0.1.45:2181/mesos`\nor\n`176.0.1.45:2181`",
    "12-0": "`IGNITE_CONFIG_XML_URL`",
    "12-1": "The URL to Apache Ingite config file. HDFS path supported.",
    "12-2": "`N/A`",
    "12-3": "`https://example.com/default-config.xml` or\n`hdfs://localhost:9000/foo/default-config.xml`",
    "15-0": "`IGNITE_USERS_LIBS_URL`",
    "15-1": "Comma separated list of ulrs to libs which will be added to classpath. HDFS path supported.",
    "15-2": "`N/A`",
    "15-3": "`https://example.com/lib.zip,`\n`https://example.com/lib1.zip`",
    "13-0": "`IGNITE_PACKAGE_URL`",
    "13-1": "The URL to Apache Ignite build. HDFS path supported. Might be useful if using own build.",
    "13-2": "`N/A`",
    "13-3": "`https://example.com/apache-ignite-1.6.1.zip`\nor\n`hdfs://localhost:9000/foo/apache-ignite-1.6.1.zip`"
  },
  "cols": 4,
  "rows": 17
}
