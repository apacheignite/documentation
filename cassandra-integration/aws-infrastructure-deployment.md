...
4. The AWS account you are using, should have [permissions](http://docs.aws.amazon.com/IAM/latest/UserGuide/access_permissions.html) to list IAM roles and assign the role specified above to EC2 instances.
...
| <sup>**CASSANDRA_DOWNLOAD_URL**      | <sup>URL to download Cassandra. Modify this parameter if you want to use some particular version of Cassandra.|
...
[/block]
Let's now look at how we can monitor the status of deployment process (and load tests execution), cause you want to know how thing are going.
[block:api-header]
{
  "type": "basic",
  "title": "Monitoring"
