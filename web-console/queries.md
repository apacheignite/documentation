...
[/block]
Ignite supports free-form SQL queries without any limitations. The SQL syntax is ANSI-99 compliant which means that you can use any SQL function, aggregation, grouping or joins. You can create any number of queries on the same page, and the results can viewed in tabular form or graphs. 
[block:image]
{
  "images": [
    {
