...
[/block]
Using the Ignite Web Console Summary feature, you can download Ignite configurations in XML and Java, as well as Java domain model POJOs that you can copy into your project. A ready-to-use Maven based project can also be downloaded from this page.
[block:image]
{
  "images": [
    {
