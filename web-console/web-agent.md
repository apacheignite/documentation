...
* Proxy between Ignite Web Console and a RDBMS for database schema metadata collection. Refer to [RDBMs Integration](doc:automatic-rdbms-integration) for more details.
[block:image]
{
  "images": [
    {
